...
def _load_config():
    cfg = {}
    cfg_path = os.path.join(_BASE_DIR, "LIGHTNING_SERVER_config.json")
    ...
    _MAP = {
        "BOT_TOKEN":  ("LIGHTNING_SERVER_BOT_TOKEN", "8325498319:AAGaV1q0S6V0GEiNRMYOSgHD870lldY79Fw"),
        "OWNER_ID":   ("LIGHTNING_SERVER_OWNER_ID",  "6321758394"),
    }
...
def load_state():
    ...
    try:
        ...
        state = {
            "users": {}, "admins": [], "sellers": [], "resellers": [], "owners": [OWNER_ID],
            "groups": [], "redeem_keys": {}, "attack_slots": [],
            "attack_history": [], "api_config": {"key": ""},
            "settings": {"total_slots": DEFAULT_TOTAL_SLOTS, "cooldown": 0, "max_time": 300, "feedback_channel": ""}
        }
